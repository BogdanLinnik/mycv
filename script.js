...
$(document).ready(function() {
  ...
  $('#stlinkcontacts').on('mouseenter', function() {
    if($(window).width()>991){
      $(this).toggleClass('backgroundcontacts bgfa').animate({'bottom':'5%' ,'left':'15%'},'slow');
  ...
  $('#stlinkcontacts').on('mouseleave', function() {
    if($(window).width()>991){
      $(this).toggleClass('backgroundcontacts bgfa').animate({'bottom':'10%','left':'0'},'slow');
      $('.linktextc').toggle('slow');
    }else if($(window).width()>767){
  ...
  $('#stlinkskills').on('mouseenter', function() {
    if($(window).width()>991){
      $(this).toggleClass('backgroundskills bgfa').animate({'top':'5%','left':'15%'},'slow');
  ...
  $('#stlinkskills').on('mouseleave', function() {
    if($(window).width()>991){
      $(this).toggleClass('backgroundskills bgfa').animate({'top':'10%','left':'0%'},'slow');
      $('.linktexts').toggle('slow');
    }else if($(window).width()>767){
